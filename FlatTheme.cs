...
namespace MonoFlat
{
    ...
    public class MonoFlat_SocialButton : Control
    {
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            G.FillEllipse(new SolidBrush(EllipseColor), new Rectangle(0, 0, 85, 85));

            // HINTS:
            // The best size for the drawn image is 64x64\
    ...
    #endregion
    #region  Small Social Button

    public class MonoFlat_SocialButtonSmall : Control
    {
        ...
        public MonoFlat_SocialButtonSmall()
        {
            DoubleBuffered = true;
            EllipseColor = Color.FromArgb(66, 76, 85);
        }
